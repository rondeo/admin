<template>
  <div class="mod-user">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      <el-form-item>
        <el-input v-model="dataForm.userName" placeholder="奖品名称" clearable></el-input>
      </el-form-item>
      <el-form-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$loading.open()
        this.$http({
          url: this.$http.adornUrl('/exchange-code/prize/getListPage'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`确定对[id=${userIds.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/exchange-code/sys/user/delete'),
            method: 'post',
